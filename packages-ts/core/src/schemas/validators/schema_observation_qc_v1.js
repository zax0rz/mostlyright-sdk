...
const err8 = {instancePath:instancePath+"/as_of_time",schemaPath:"#/properties/as_of_time/type",keyword:"type",params:{type: schema37.properties.as_of_time.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err8];
}
else {
...
const err9 = {instancePath:instancePath+"/detector_metadata",schemaPath:"#/properties/detector_metadata/type",keyword:"type",params:{type: schema37.properties.detector_metadata.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err9];
}
else {
...
const err12 = {instancePath:instancePath+"/flag",schemaPath:"#/properties/flag/enum",keyword:"enum",params:{allowedValues: schema37.properties.flag.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err12];
}
else {
...
const err13 = {instancePath:instancePath+"/ingestion_id",schemaPath:"#/properties/ingestion_id/type",keyword:"type",params:{type: schema37.properties.ingestion_id.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err13];
}
else {
...
const err14 = {instancePath:instancePath+"/observation_kind",schemaPath:"#/properties/observation_kind/type",keyword:"type",params:{type: schema37.properties.observation_kind.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err14];
}
else {
...
const err15 = {instancePath:instancePath+"/observation_kind",schemaPath:"#/properties/observation_kind/enum",keyword:"enum",params:{allowedValues: schema37.properties.observation_kind.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err15];
}
else {
...
const err17 = {instancePath:instancePath+"/parser_name",schemaPath:"#/properties/parser_name/type",keyword:"type",params:{type: schema37.properties.parser_name.type},message:"must be null,string"};
if(vErrors === null){
vErrors = [err17];
}
else {
...
const err22 = {instancePath:instancePath+"/source",schemaPath:"#/properties/source/enum",keyword:"enum",params:{allowedValues: schema37.properties.source.enum},message:"must be equal to one of the allowed values"};
if(vErrors === null){
vErrors = [err22];
}
else {
...
validate26.evaluated = {"props":{"as_of_time":true,"detector_metadata":true,"field":true,"flag":true,"ingestion_id":true,"observation_kind":true,"observed_at":true,"parser_name":true,"qc_system":true,"qc_version":true,"rule_id":true,"source":true,"station_code":true},"dynamicProps":false,"dynamicItems":false};
