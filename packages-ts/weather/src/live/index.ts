// Phase 11 — `@mostlyrightmd/weather/live` subpath barrel.
//
...
// (`dist/live/index.{mjs,cjs,d.ts}`). The main `@mostlyrightmd/weather`
// barrel re-exports the same surface, so both of these work:
//
//   import { stream } from "@mostlyrightmd/weather/live"  // narrow subpath
...
//
// LiveStreamError + NoLiveDataError live on `@mostlyrightmd/core`
