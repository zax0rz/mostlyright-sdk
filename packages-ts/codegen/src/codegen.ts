// @mostlyright/codegen — CLI entry point.
//
...
//
// Usage:
//   pnpm --filter @mostlyright/codegen run codegen          # emit files
//   pnpm --filter @mostlyright/codegen run codegen --check  # determinism check
//
...
function emitValidators(out: FileMap): void {
  ...
  const barrelLines: string[] = [
    header("(generated)"),
    "",
    "// ajv-standalone validators compiled by @mostlyright/codegen at build time.",
