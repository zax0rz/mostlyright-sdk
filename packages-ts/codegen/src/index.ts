// @mostlyrightmd/codegen — public entry. The CLI implementation lives in
...
export function helloCodegen(): string {
  return "hello @mostlyrightmd/codegen";
}
 ...
 *
 * Most callers should invoke the CLI (`pnpm --filter @mostlyrightmd/codegen
