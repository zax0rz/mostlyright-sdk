// @mostlyright/codegen — public entry. The CLI implementation lives in
...
export function helloCodegen(): string {
  return "hello @mostlyright/codegen";
}
 ...
 *
 * Most callers should invoke the CLI (`pnpm --filter @mostlyright/codegen
