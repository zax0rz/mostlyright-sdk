"""Tests for mostlyright.weather._awc — AWC METAR transform."""
...
class TestIcaoToStationCode:
    ...
    def test_conus_4letter_strips_k(self) -> None:
        from mostlyright.weather._awc import icao_to_station_code
...
class TestMapCloudCover:
    ...
    def test_valid_codes(self) -> None:
        from mostlyright.weather._awc import map_cloud_cover
...
class TestParseAwcVisibilityEdges:
    ...
    def test_empty_string_returns_none(self) -> None:
        from mostlyright.weather._awc import parse_awc_visibility
...
class TestParseTgroup:
    ...
    def test_positive_temps(self) -> None:
        from mostlyright.weather._awc import _parse_tgroup
